...
//		return dateFormatter.string(from: self).appending("Z")
        return DateUtils.shared.stringFromDate(self, format: "yyyy-MM-dd'T'HH:mm:ssXXX")
	}
...
//		dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSZ"
        guard let date =  DateUtils.shared.dateFromString(iso8601String, format: "yyyy-MM-dd'T'HH:mm:ssXXX") else {
            return nil
        }
        self = date
	}
